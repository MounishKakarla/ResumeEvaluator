...
import { searchCandidates, searchResumes, deleteCandidate, bulkDeleteCandidates, updateCandidate, getAuditLog } from '../api/client'
import type { CandidateSearchItem, ResumeSearchHit, CandidateUpdate, AuditLogEntry } from '../api/client'
...
type SearchTab = 'candidates' | 'resume' | 'audit'
