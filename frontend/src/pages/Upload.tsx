...
import { uploadResume, getResumes, deleteResume, deleteAllResumes, archiveResume, reparseAllCandidates, API_BASE_URL } from '../api/client'
import type { UploadResponse, ParseSettings } from '../api/client'
...
export default function Upload() {
  ...
  const { uploadQueue: queue, setUploadQueue: setQueue } = useAppStore()
  ...
  return (
    <div className="flex h-[calc(100vh-56px)]">
      ...
      <div className="flex-1 flex flex-col gap-4 p-6 overflow-y-auto">
        ...
        {/* Run Evaluation moved to Job Roles (Configure) page */}
        ...
        {/* ── Stored Resumes / Evaluated Resumes — hidden per request ── */}
        {false && (
